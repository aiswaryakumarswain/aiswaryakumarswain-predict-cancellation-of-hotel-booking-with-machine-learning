...
hotel2 = pd.read_csv(
    r'C:\Users\aiswa\Final-Project-Hotel-Cancellation-Prediction\Flask\data\hotel_final.csv', engine='python')
...
def preview():
    df = pd.read_csv(
        r'C:\Users\aiswa\Final-Project-Hotel-Cancellation-Prediction\Flask\data\hotel_final.csv')
...
def analyze():
    ...
    model = joblib.load(
        r'C:\Users\aiswa\Final-Project-Hotel-Cancellation-Prediction\hotel_tuned')
    ...
    cur.execute("INSERT INTO users(hotel,location,lead_time,market_segment,deposit_type,parking_space,total_of_special_request, is_previously_cancelled,is_repeated_guest,is_booking_changes,customer_type,total_stays,total_guest,cancel_chance,prediction) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                (hotel, location, lead_time, market_segment, deposit_type, parking_space, total_of_special_request, is_previously_cancelled, is_repeated_guest, is_booking_changes, customer_type, total_stays, total_guest, round_prediction, final_prediction))
